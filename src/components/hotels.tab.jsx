            ...
            <div className="HotelsTab"  >
                <Card variant="outlined" sx={{ width: "100%", gridArea: "1/1/3/2" }} className="HotelCard">
                    ...
                    <CardContent>
                        ...
                        <span style={{ fontWeight: "100", color: "purple", fontSize: "0.8rem" }}>4.8/5 Excellent <span style={{ color: "GrayText" }}>(1214 reviewes)</span></span>
                ...
                <Card variant="outlined" sx={{ width: "100%", gridArea: "3/3/5/4" }} className="HotelCard">
                    <CardOverflow>
                        <AspectRatio ratio="2">
                            <img
                                src={hotel7}
                ...
                <Card variant="outlined" sx={{ width: "100%", gridArea: "3/4/5/5" }} className="HotelCard">
                    <CardOverflow>
                        <AspectRatio ratio="2">
                            <img
                                src={hotel8}
