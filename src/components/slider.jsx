...
import hotel7 from "../images/The St_ Regis Shenzhen—Deluxe City View Room.jpg"
import hotel8 from "../images/20 Hotel Suites Around the World That Are Almost Too Luxurious.jpg"
import { Pagination } from 'swiper/modules';
const Slider = () => {
    return (
        <>
            <div className="Slider">
                <h4 style={{ borderBottom: "3px solid #2f60ae", paddingBottom: "10px", width: "fit-content", margin: "10vh auto" }}>Our best promotional tours</h4>
                <Swiper
                    slidesPerView={3}
                    spaceBetween={10}
                    loop={true}
                ...
                >
                    ...
                    <SwiperSlide> <Card variant="outlined" sx={{ width: "100%", gridArea: "1/2/3/3" }} className="HotelCard">
                        <CardOverflow>
                            <AspectRatio ratio="2">
                                <img
                                    src={hotel2}
                    ...
                    <SwiperSlide><Card variant="outlined" sx={{ width: "100%", gridArea: "1/3/3/4" }} className="HotelCard">
                        <CardOverflow>
                            <AspectRatio ratio="2">
                                <img
                                    src={hotel3}
                    ...
                    <SwiperSlide><Card variant="outlined" sx={{ width: "100%", gridArea: "1/4/3/5" }} className="HotelCard">
                        <CardOverflow>
                            <AspectRatio ratio="2">
                                <img
                                    src={hotel4}
                    ...
                    <SwiperSlide><Card variant="outlined" sx={{ width: "100%", gridArea: "3/1/5/2" }} className="HotelCard">
                        <CardOverflow>
                            <AspectRatio ratio="2">
                                <img
                                    src={hotel5}
                    ...
                    <SwiperSlide><Card variant="outlined" sx={{ width: "100%", gridArea: "3/2/5/3" }} className="HotelCard">
                        <CardOverflow>
                            <AspectRatio ratio="2">
                                <img
                                    src={hotel6}
                        ...
                        <CardContent>
                            ...
                            <span style={{ fontWeight: "100", fontSize: "0.8rem", color: "purple" }}>4.8/5 Excellent <span style={{ color: "GrayText" }}>(1214 reviewes)</span></span>
                            <span style={{ fontSize: "0.rem" }}>Price starts from <span style={{ fontSize: "20px", fontWeight: "600" }}>$90.00</span></span>
                        </CardContent>

                    </Card>
                    </SwiperSlide>
                    <SwiperSlide><Card variant="outlined" sx={{ width: "100%", gridArea: "3/3/5/4" }} className="HotelCard">
                        <CardOverflow>
                            <AspectRatio ratio="2">
                                <img
                                    src={hotel7}
                        ...
                        <CardContent>
                            <span style={{ fontSize: "18px", fontWeight: "500" }}>zefi resort and spa</span>
                            <span style={{ fontWeight: "100", fontSize: "0.8rem", color: "purple" }}>4.8/5 Excellent <span style={{ color: "GrayText" }}>(1214 reviewes)</span></span>
                            <span style={{ fontSize: "0.8rem" }}>Price starts from <span style={{ fontSize: "20px", fontWeight: "600" }}>$89.00</span></span>
                        </CardContent>

                    </Card>
                    </SwiperSlide>
                    <SwiperSlide><Card variant="outlined" sx={{ width: "100%", gridArea: "3/4/5/5" }} className="HotelCard">
                        <CardOverflow>
                            <AspectRatio ratio="2">
                                <img
                                    src={hotel8}
                        ...
                        <CardContent>
                            <span style={{ fontSize: "18px", fontWeight: "500" }}>manila international resort</span>
                            <span style={{ fontWeight: "100", fontSize: "0.8rem", color: "purple" }}>4.8/5 Excellent <span style={{ color: "GrayText" }}>(1214 reviewes)</span></span>
                            <span style={{ fontSize: "0.8rem" }}>Price starts from <span style={{ fontSize: "20px", fontWeight: "600" }}>$90.00</span></span>
                        </CardContent>
